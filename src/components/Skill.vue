...
<template>
    <div class="container">
        ...
        <div class="container-slot">
            ...
            <div class="slot">
                <img src="../../public/C++Logo.svg" alt="">
                <h3>C++</h3>
            </div>
            <div class="slot">
                <img src="../../public/PythonLogo.svg" alt="">
                <h3>Python</h3>
            </div>
        </div>
        ...
        <div class="container-slot">
            ...
            <div class="slot">
                <img src="../../public/AndroidLogo.svg" alt="">
                <h3>Androïd</h3>
            </div>
            <div class="slot">
                <img src="../../public/PlaystationLogo.svg" alt="">
                <h3>PlayStation 4/5</h3>
            </div>
            <div class="slot">
                <img src="../../public/XboxLogo.svg" alt="">
